...
const UpdateConcernScreen = () => {
  ...
  const renderComplaintDetails = () => {
    ...
    const {
      ...
      remarks,
      closed_on,
      parent_info: { id: parentId, name: parentName, avatar: parentAvatar },
      student_info: { id: studentId, name: studentName, avatar: studentAvatar },
    } = taskInfo;
    return (
      <View
        style={{
      ...
      >
        ...
        <InformationView label={"Class"} value={"3rd B Section"} />
        ...
        >
          <View>
            ...
            >
              ...
              />
              <View
                style={{ flexGrow: 1, flexShrink: 1, marginHorizontal: 16 }}
              >
                <Text
                  style={{
              ...
              >
                ...
                <Text style={{fontFamily:"RHD-Medium",fontSize:14,lineHeight:21}}>Open</Text>
                <Feather name="chevron-down" size={16} color={secondaryText} />
                </View>
              </TouchableOpacity>
            </View>

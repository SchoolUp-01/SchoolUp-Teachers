...
const AddMemoriesScreen = () => {
  ...
  const handleSubmit = () => {
    ...
    setLoading(true);
    supabase_api.shared
      .addStudentMemory(title, description, type, mediaList,classList)
      .then((res) => {
    ...
    <Container>
      ...
      <View style={styles.toolbarView}>
        <View style={styles.headerView}>
          ...
          <Text style={styles.headerText}>Student Moments</Text>
          <TouchableOpacity
            style={{
              marginEnd: 16,
              alignSelf: "center",
          ...
          >
            {loading ? <ActivityIndicator size={24} color={primaryColor}  />:<Text
              style={{
                fontSize: 16,
                fontFamily:  (title==="" || mediaList?.length == 0)?"RHD-Medium":"RHD-Bold",
                color: (title==="" || mediaList?.length == 0)?secondaryText:primaryColor,
              }}
            >
              Upload
            </Text>}
      ...
      <ContentView>
        ...
        {/* <TouchableOpacity onPress={() => handleSubmit()}>
          <View style={styles.primaryButton}>
            ...
            {!loading && <Text style={styles.primaryText}>Upload </Text>}
          </View>
        </TouchableOpacity> */}
      </ContentView>
    </Container>
...
export default React.memo(AddMemoriesScreen);

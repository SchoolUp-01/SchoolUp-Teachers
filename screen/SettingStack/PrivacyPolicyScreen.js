...
import { Container, InputTitle, MenuItem, Title, Toolbar } from "../../components/styledComponents";
import CustomStatusBarView from "../../components/CustomStatusBarView";
import { Feather } from "@expo/vector-icons";
import { primaryColor_50, primaryText, secondaryText } from "../../utils/Color";
      ...
      <ScrollView>
          <View style={{ paddingHorizontal: 20, paddingBottom: 8 }}>
            <Text style={styles.caption}>
              SchoolUp built the SchoolUp app as a Free app. This SERVICE is
              provided by SchoolUp at no cost and is intended for use as is.
              ...
              accessible at SchoolUp unless otherwise defined in this Privacy
              Policy.{"\n\n"}We understand that your privacy is important, and
              we respect your right to control your personal information. This
              privacy policy explains how we collect, use, and protect the
              personal information that you provide when you submit
              user-generated content (UGC) to our application.
            </Text>
            <InputTitle style={styles.header}>Information Collection and Use</InputTitle>
            <Text style={styles.caption}>
              For a better experience, while using our Service, we may require
              you to provide us with certain personally identifiable
              information, including but not limited to Email, Name, About,
              Website, Google Public Profile and Facebook Public profile. The
              ...
              information from you, such as your name, email address, and any
              other information that you voluntarily provide in connection with
              your submission. We may also collect non-personal information,
              such as your IP address and the type of device you are using.
            </Text>
           <InputTitle style={styles.header}>How We Use Your Information</InputTitle>
            <Text style={styles.caption}>
              We use your personal information only for the purpose of
              displaying and promoting your UGC on our application. We may also
              use your personal information to contact you regarding your
              submission or to respond to any inquiries or requests that you
              make. We will not use your personal information for any other
              purpose without your explicit consent.
            </Text>
           <InputTitle style={styles.header}>How We Protect Your Information</InputTitle>
            <Text style={styles.caption}>
              We take the security of your personal information seriously and
              take reasonable measures to protect it. We use industry-standard
              encryption and security protocols to prevent unauthorized access,
              disclosure, or alteration of your personal information.
            </Text>
           <InputTitle style={styles.header}>Disclosure of Your Information</InputTitle>
            <Text style={styles.caption}>
              We will not sell, trade, or otherwise transfer your personal
              information to any third party without your explicit consent.
              However, we may disclose your personal information if required by
              law or if we believe in good faith that such disclosure is
              necessary to protect our rights, property, or safety, or the
              rights, property, or safety of others.
            </Text>
           <InputTitle style={styles.header}>Log Data</InputTitle>
            <Text style={styles.caption}>
           ...
           <InputTitle style={styles.header}>Cookies</InputTitle>
            <Text style={styles.caption}>
           ...
           <InputTitle style={styles.header}>Service Providers</InputTitle>
            <Text style={styles.caption}>
           ...
           <InputTitle style={styles.header}>Security</InputTitle>
            <Text style={styles.caption}>
           ...
           <InputTitle style={styles.header}>Links to Other Sites</InputTitle>
            <Text style={styles.caption}>
           ...
           <InputTitle style={styles.header}>Children’s Privacy</InputTitle>
            <Text style={styles.caption}>
           ...
           <InputTitle style={styles.header}>Changes to This Privacy Policy</InputTitle>
            <Text style={styles.caption}>
              We may update our Privacy Policy from time to time. Thus, you are
              advised to review this page periodically for any changes. We will
              notify you of any changes by posting the new Privacy Policy on
              this page. This policy is effective as of 2023-02-15
            </Text>
          </View>
        </ScrollView>
    </Container>
